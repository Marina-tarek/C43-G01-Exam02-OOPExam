...
namespace ExamOOP
{
    public class MCQ : Question
    {
        ...
        {
            bool markInput, rightAnswerInput;
            decimal mark;
            ...
            do
            {
                ...
                markInput = decimal.TryParse(Console.ReadLine(), out mark);

            } while (!(markInput && mark > 0));
            ...
            do
            {
                ...
                rightAnswerInput = int.TryParse(Console.ReadLine(), out rightAnswerId);

            } while (!(rightAnswerInput && rightAnswerId is 1 or 2 or 3));
